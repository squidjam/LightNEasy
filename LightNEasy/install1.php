...
<head>
<title>LightNEasy 3.2.5 Install - 2</title>
...
print "<h4>Installation Successfull!</h4>\n";
print "<p>You should make sure the files install.php and install1.php inside LightNEasy folder were deleted, for security reasons.</p>\n";
print "<p align=\"center\"><a href=\"../LightNEasy.php\">Start LightNEasy!</a></p>\n";
} else {
	print "<h4>Please try Again!</h4>\n";
	print "<p>All fields have to be filled</p>\n";
	print "<p>Passwords are either empty or don't match!</p>\n";
	entryform();
}
} else {
	if(file_exists("../data/database.php")) {
		print "<h4>LightNEasy was already installed</h4>\n";
		print "<p>If you want to reinstall LightNEasy from scratch, delete the file \"whatever.db\" and \"database.php\" and run install again</p>\n";
	} else {
		print "<h4>LightNEasy will create the database</h4>\n";
		print "<p>Please input all fields below</p>\n";
		entryform();
	}
} ?>
<p>&nbsp;</p>
